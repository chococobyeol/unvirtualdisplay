...
Unvirtual Display includes or bundles the following major open-source components:

- Electron — MIT License
- React and React DOM — MIT License
- Three.js — MIT License
- `@pixiv/three-vrm` — MIT License
- Rapier JavaScript bindings — Apache License 2.0
...
- Noto Sans CJK 2.004 (KR, JP, and Simplified Chinese subsets) — SIL Open Font License 1.1
