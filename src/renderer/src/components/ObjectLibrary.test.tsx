...
const categories: ObjectLibraryCategoryView[] = [
  ...
  { id: 'acrylicCases', label: 'Acrylic cases' },
  { id: 'risers', label: 'Stands & steps' },
  { id: 'shelvesParts', label: 'Shelves & parts' }
]

const entries: ObjectLibraryEntryView[] = [
  { id: 'case-modern1', name: 'Modern · 1 tier', description: '1-tier case with a back panel', preview: '/modern1.jpg' },
  { id: 'case-modern2', name: 'Modern · 2 tiers', description: '2-tier case with a back panel', preview: '/modern2.jpg' }
]
