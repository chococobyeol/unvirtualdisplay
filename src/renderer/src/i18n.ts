...
const resources = {
  ...
  en: {
    translation: {
      ...
      displayCase: 'Display case', caseObject: 'Display case', modern1: 'Modern · 1 tier', modern2: 'Modern · 2 tiers', modern3: 'Modern · 3 tiers', glass1: 'Glass · 1 tier', glass2: 'Glass · 2 tiers', glass3: 'Glass · 3 tiers', wood1: 'Wood · 1 tier', wood2: 'Wood · 2 tiers', wood3: 'Wood · 3 tiers',
  ...
  ja: {
    translation: {
      ...
      displayCase: 'ケース', caseObject: 'ケース', modern1: 'モダン · 1段', modern2: 'モダン · 2段', modern3: 'モダン · 3段', glass1: 'ガラス · 1段', glass2: 'ガラス · 2段', glass3: 'ガラス · 3段', wood1: '木製 · 1段', wood2: '木製 · 2段', wood3: '木製 · 3段',
  ...
  'zh-Hans': {
    translation: {
      ...
      emptyHint: 'GLB · GLTF · VRM · FBX · OBJ · PNG · JPG · WebP', displayCase: '展示柜类型', modern1: '现代 · 1层', modern2: '现代 · 2层', modern3: '现代 · 3层',
      glass1: '玻璃 · 1层', glass2: '玻璃 · 2层', glass3: '玻璃 · 3层', wood1: '木质 · 1层', wood2: '木质 · 2层', wood3: '木质 · 3层', caseObject: '展示柜', inspector: '属性', noSelection: '选择展示柜或展品后可以调整详细设置。', transform: '布局',
