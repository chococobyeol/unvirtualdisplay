...
const resources = {
  ...
  en: {
    translation: {
      ...
      balanced: 'Balanced', high: 'High', lighting: 'Lighting', lightIntensity: 'Brightness', shadows: 'Shadows',
  ...
  ja: {
    translation: {
      ...
      balanced: '標準', high: '高', lighting: '照明', lightIntensity: '明るさ', shadows: '影', saving: '保存中…',
  ...
  'zh-Hans': {
    translation: {
      ...
      lightIntensity: '亮度', shadows: '阴影', saving: '正在保存…', saved: '已保存到本地', loading: '正在准备展示柜…',
